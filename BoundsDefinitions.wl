...
(* ::Text:: *)
(*(*Numerical  values for known constants used in the calculation of the bounds of a scalar leptoquark couplings of charge 5/3 from the muon anomaly and the tau decay \[Tau]->c\[Gamma] as described in manuscript https://arxiv.org/abs/2208.05064 by A. Bola\[NTilde]os, R. S\[AAcute]nchez V\[EAcute]lez and G. Tavares Velasco*)*)
...
(* ::Text:: *)
(*(*Functions to calculate the contribution of a scalar LQ to the muon anomaly and the decay \[Tau]->\[Mu]\[Gamma] as described in Appendix C of the manuscript https://arxiv.org/abs/2208.05064*)*)
...
(* ::Text:: *)
(* (*The Bounda\[Mu] function takes a scalar LQ with a mass mS and  randomly scans iter times for a set of {\[Lambda]Lmuc,\[Lambda]Rmuc,\[Lambda]Lmut,\[Lambda]Rmut} values  from (10^-2) to 1.  It is then tested if those LQ coupling values are consistent with the discrepancy of the muon anomaly given by Eq. (C1) of our manuscript and if true those sets of values are added to the list points, which is obtained after evaluating this function. Additionaly the function can receive as arguments the signs of the each coupling via the variables sign\[Lambda]Lmuc,sign\[Lambda]Lmut,sign\[Lambda]Rmuc, and sign\[Lambda]Rmut. *)*)


Bounda\[Mu][mS_,iter_,sign\[Lambda]Lmuc_,sign\[Lambda]Lmut_,sign\[Lambda]Rmuc_:1,sign\[Lambda]Rmut_:1]:=(
points={};
Clear[\[Lambda]Lmuc,\[Lambda]Rmuc,\[Lambda]Lmut,\[Lambda]Rmut];
a\[Mu]=Re[MDMPV[mmu,{mc,mt},{mS},{Qu,Qu},{QS1},{{\[Lambda]Lmuc,\[Lambda]Lmut},{}},{{\[Lambda]Rmuc,\[Lambda]Rmut},{}}]];
Do[{\[Lambda]Lmuc=sign\[Lambda]Lmuc 10^RandomReal[{-2,0}],\[Lambda]Rmuc=sign\[Lambda]Rmuc 10^RandomReal[{-2,0}],\[Lambda]Lmut=sign\[Lambda]Lmut 10^RandomReal[{-2,0}],\[Lambda]Rmut= sign\[Lambda]Rmut 10^RandomReal[{-2,0}]};
If[\[CapitalDelta]min 10^-11<= a\[Mu]<=\[CapitalDelta]max 10^-11,
points=AppendTo[points,{\[Lambda]Lmuc,\[Lambda]Rmuc,\[Lambda]Lmut,\[Lambda]Rmut}]],{i,1,iter}];points)


(*For the list of LQ couplings {\[Lambda]Lmuc,\[Lambda]Rmuc,\[Lambda]Lmut,\[Lambda]Rmut} consistent with the discrepancy of the muon anomaly obtained from the Bounda\[Mu] function for a scalar LQ with mass mS, the Bound function randomly scans iter times for a sets of {\[Lambda]Ltauc,\[Lambda]Rtauc,\[Lambda]Ltaut,\[Lambda]Rtaut} values  from (10^-2) to 1.  It is then tested if those LQ coupling values are consistent with the current experimental bound on the \[Tau]->\[Mu]\[Gamma] decay (Eq. (C5) of our manuscript https://arxiv.org/abs/2208.05064) and if true those sets of values are added to the list list, which is obtained after evaluating this function. *)


Bound[mS_,list_,iter_]:=(
newpoints={};
Clear[\[Lambda]Lmuc,\[Lambda]Rmuc,\[Lambda]Lmut,\[Lambda]Rmut,\[Lambda]Ltauc,\[Lambda]Rtauc,\[Lambda]Ltaut,\[Lambda]Rtaut];
BR=BR\[Tau]to\[Mu]\[Gamma][{mc,mt},{mS},{QS1},{{\[Lambda]Ltauc,\[Lambda]Ltaut},{}},{{\[Lambda]Lmuc,\[Lambda]Lmut},{}},{{\[Lambda]Rtauc,\[Lambda]Rtaut},{}},{{\[Lambda]Rmuc,\[Lambda]Rmut},{}}];
Do[{\[Lambda]Lmuc=list[[i]][[1]],\[Lambda]Rmuc=list[[i]][[2]],
\[Lambda]Lmut=list[[i]][[3]],
\[Lambda]Rmut=list[[i]][[4]]};
Do[
\[Lambda]Ltauc=10^RandomReal[{-2,0}];\[Lambda]Rtauc=10^RandomReal[{-2,0}];
\[Lambda]Ltaut=10^RandomReal[{-2,0}];\[Lambda]Rtaut=10^RandomReal[{-2,0}];
If[BR<=BRexp\[Tau]\[Mu]\[Gamma] ,  newpoints=AppendTo[newpoints,{\[Lambda]Lmuc, \[Lambda]Rmuc,\[Lambda]Lmut,\[Lambda]Rmut,\[Lambda]Ltauc,\[Lambda]Rtauc,\[Lambda]Ltaut,\[Lambda]Rtaut}]],{j,1,iter}],{i,1,Length[list]}];newpoints)
